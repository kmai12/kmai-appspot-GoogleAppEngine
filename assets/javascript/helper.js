...
var HTMLskillsStart = "<h3 id='skillsH3'>Skills:</h3><ul id='skills' class='flex-box-2'></ul>";
var HTMLskills = "<li class='flex-item'><span class='white-text'>%data%</span></li>";

var HTMLworkStart = "<div class='work-entry'></div>";
var HTMLworkEmployer = "<span class='bold-blue'>%data%</span><br>";
var HTMLworkTitle = "<span class='sub-bold-blue'><i>%data%</i></span><br>";
// " - <i>%data%</i></b><br>";
...
var HTMLprojectTitle = "<div class='bold-blue'>%data%</div>";
var HTMLprojectDates = "<div class='date-text'>%data%</div>";
var HTMLprojectDescription = "<p><br>%data%</p>";
var HTMLprojectImage = "<img src='%data%'>";

var HTMLschoolStart = "<div class='education-entry'></div>";
var HTMLschoolName = "<div class='bold-blue'>%data%<br></div>";
